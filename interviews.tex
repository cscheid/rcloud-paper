...
Integrating R helps Allison's application: ``Having an open session where I can run R commands or
...
% we don't need a new paragraph here - -scn
Eric tried to keep his notebook tree well organized, but this didn't help,
because some people kept old links in email, or forked notebooks which 
had become obsolete.
% By design, notebooks that are deleted in the user interface
% are not purged from the repository.
He says he became reluctant to share notebooks: ``Do I want to support this forever?''
