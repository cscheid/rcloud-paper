...
\gordon{Add user statistics here: number of notebooks, forks, stars, users
who have done one of these things. Number of users who use RCloud a lot,
a moderate amount, or just tried it out.}
...
But forking also provides a way for others to troubleshoot when something goes wrong.
...
But global search doesn't work for everyone, and may need to be refined. Other users
...
Horace: ``Well, the nice thing is if you have the whole notebook, you can run it
...
Raif: ``cells are really useful'' but ``you want to see your output in a
...
Taylor: ``That's just a problem because people will have old notebooks that
