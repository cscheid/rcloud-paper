...
\todor{Browse/Search}. ``More like this'', and a custom webpage solely for browsing.
...
This is similar to models like Jankun-Kelly et al.'s p-set calculus \todo{cite}
and VisTrails's version tree \todo{cite}, where every change in the state of the
system is tracked.
