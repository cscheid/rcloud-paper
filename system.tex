...
\todo{Browse/Search}. ``More like this'', and a custom webpage solely for browsing.
...
gist API was succesful. We expect related projects would gain many
...
\subsection{Interactive notebooks, etc.}
...
In addition, R is naturally better as a language for analysis, and
JavaScript as a language for interactive visualization.  To draw on
...
and \emph{first-class functions} available across the network link.
This provides great flexibility, so that for example, a chart built
