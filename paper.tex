...
\teaser{
  \centering
  \includegraphics[width=.28\linewidth]{fig/screenshots/wdcplotsmall.jpg}
  %% \includegraphics[width=.9\linewidth]{figs/teaser.jpg}
  \hspace{1em}
  \includegraphics[width=.6\linewidth]{fig/casestudy1/casestudy1.graffle/image8.png}
  % \vspace{-.5em}
  \caption{RCloud provides infrastructure for data science teams so
    ...
    \carlos{Replace this with something using either a Shiny demo or in-process nanocubes?}
  }
% \vspace{-.5em}
}
