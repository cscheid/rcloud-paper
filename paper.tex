...
\abstract{ Consider the emerging role of data science teams embedded in
  ...
  RCloud has been in active use for over two years by about 100 active users.
  We report on interviews with some of these users, and
  discuss the design decisions, tradeoffs and limitations.
  % comparing RCloud to other current proposals.
} % end of abstract
