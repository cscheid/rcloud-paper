...
\linespread{0.9575} % I hate myself

\title{Collaborative Visual Analysis with RCloud}
...
\author{Stephen North \thanks{e-mail: s.c.n@ieee.org}\\ %
  \scriptsize Infovisible %
  \and Carlos Scheidegger \thanks{e-mail: cscheid@cs.arizona.edu}\\ %
  \scriptsize University of Arizona %
  \and Simon Urbanek\thanks{e-mail: urbanek@research.att.com}\\ %
  \scriptsize AT\&T Labs %
  \and Gordon Woodhull\thanks{e-mail: gordon@research.att.com}\\ %
  \scriptsize AT\&T Labs}

%% \authorfooter{
%% %% insert punctuation at end of each item
%% \item 
%% Stephen North is with Infovisible, Oldwick, USA, and graphviz.org.
...
%% \item
%% Gordon Woodhull is with AT\&T Labs in New York, USA.
...
\abstract{ Consider the emerging role of data science teams embedded in
  ...
  and users: \emph{discoverability}, \emph{technology transfer},
  and \emph{coexistence}. In addition, we contribute the design and
  ...
  About 100 people used RCloud for two years.
  We report on interviews with some of these users, and
  discuss design decisions, tradeoffs and limitations in
...
\teaser{
  \centering
  \includegraphics[width=.70\linewidth]{fig/teaser/teaser.pdf}
  % \vspace{-.5em}
  \caption{ \small
An overview of features in RCloud.
RCloud is an environment in which \emph{hackers} and \emph{scripters}
solve problems in data and visual analytics and create web applications
and services.  It is a shared environment, in which \emph{discoverability} is a concern.
RCloud supports search, annotation, recommendation, and commenting for all notebooks, and provides an overview where users can \emph{browse} popular and recent analyses. When problems and data sources change frequently, deployment can become very costly; RCloud supports \emph{transparent and automatic} deployment of analyses as web pages and web services, allowing a seamless transition from data exploration to production.
  }
 \vspace{-1.5em}
}
