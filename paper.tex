...
There has been considerable work on specific techniques such as
social bookmarking \cite{Millen:2006:DSB} \cite{Heer:2007:VAV}
to support collaborative or social 
Our goal is to provide a productive environment in which such
techniques may be integrated and made available to a community.
Similarly, there are computational methods to support
high performance execution in an incremental code development
environment \cite{Guo:2010:TPI}.
