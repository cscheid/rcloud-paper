...
For example, interview comments found in {\it Data Scientists at Work}
...
\stephen{We could tell them what we're going to tell them here, but I'm
not sure that's good - unless we feel the reader will have trouble following
the path we are setting, it seems to disrupt the flow of the discussion.}
