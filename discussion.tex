...
and presentation. But the combined notebook and command line interface we designed interferes with the exploration aspect.
...
to get deleted later, and there seems to be a mental burden that \textit{bad stuff
is getting saved}.
