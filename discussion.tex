...
demonstrate techniques, share results with peers and managers, and to
transfer algorithms to other groups. Artifact histories can be accessed through the notebook
...
known to be slower. \gordon{we don't need to back that up, right? i hate
  using passive voice.} Shortcut keys can be devised if people are willing
...
unwieldy with hundreds of users with hundreds of notebooks. In addition,
