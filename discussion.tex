...
{\bf Security.}
It is critical to consider security in an environment that 

RCloud uses an object capability model that prevents
unauthenticated clients from making unauthorized accesses
to RCloud objects \cite{
